            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="status_kepemilikan" class="form-select text-kecil">
                        ...
                        <option value="nonaktif" {{ $kepemilikan->status_kepemilikan == 'nonaktif' ? 'selected' : '' }}>Non-Aktif</option>
                    </select>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.tampilDataPetani = tampilDataPetani;

    let lahanIndex = {{ count($kepemilikan->detailKepemilikan) ?? 1 }};
    ...
    function tambahLahan() {
        ...
        // hapus header tombol hapus lama
        const oldHeader = template.querySelector('.d-flex.justify-content-end');
        ...
        btnHapus.className = 'btn btn-sm btn-danger btn-hapus-lahan';
    ...
    window.tambahLahan = tambahLahan;
