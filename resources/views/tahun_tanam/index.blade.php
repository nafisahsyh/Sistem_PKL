...
<div class="container-fluid px-4 mt-5">
    <h3 class="mt-4 text-brown">Data Tahun Tanam</h3>

    <div class="card shadow-sm rounded-3">
        <div class="card-body">
            <a href="{{ route('tahun_tanam.create') }}" class="btn btn-success mb-3">
            ...
            <table class="table table-bordered table-striped align-middle table-custom">
                ...
                <tbody>
                    @forelse ($tahun_tanam as $index => $item)
                        <tr>
                            <td class="text-center">{{ $index + 1 }}</td>
                            <td>{{ $item->tahun}}</td>
                            <td class="text-center">
                                <a href="{{ route('tahun_tanam.edit', $item->id_tahun_tanam) }}"
                                    class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <form action="{{ route('tahun_tanam.destroy', $item->id_tahun_tanam) }}" method="POST"
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center py-5">
                                ...
                                <p class="text-muted mb-0" style="font-size: 0.9rem;">Belum ada data tahun</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
